...
function StatCard({ label, value, hint }) {
  return (
    <div className="surface-card interactive-card rounded-[28px] border border-white/60 bg-white/85 p-5 shadow-[0_18px_50px_rgba(15,23,42,0.05)]">
  ...
  return (
    <div className="min-h-screen text-slate-900">
      ...
      <main className="mx-auto max-w-7xl px-5 pt-8 sm:px-6 lg:px-8">
        <section className="surface-card rounded-[36px] border border-white/60 bg-[linear-gradient(135deg,rgba(255,255,255,0.96),rgba(255,255,255,0.74))] p-8 shadow-[0_30px_80px_rgba(15,23,42,0.08)]">
          <div className="mb-6 inline-flex rounded-full border border-indigo-200 bg-white px-4 py-2 text-xs font-semibold text-slate-500 shadow-[0_8px_20px_rgba(15,23,42,0.08)] transition hover:border-indigo-300 hover:text-slate-700">
            <Sparkles className="mr-2 h-4 w-4 text-indigo-500" />
            Sales transcript analysis
          </div>
          <h1 className="display-font max-w-5xl text-4xl font-bold tracking-[-0.06em] text-slate-950 sm:text-6xl">
            Turn sales calls into pipeline intelligence.
          </h1>
          <p className="mt-5 max-w-4xl text-base leading-8 text-slate-600 sm:text-lg">
            Paste a transcript or upload a <code className="rounded bg-slate-100 px-2 py-1 text-sm text-slate-600">.txt</code>{" "}
            file. SalesSignal AI extracts MEDDIC, objections, deal risk, and rep coaching automatically.
          </p>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <button
              ...
              className="button-elevated inline-flex items-center gap-2 rounded-2xl bg-slate-950 px-5 py-3 text-sm font-semibold text-white shadow-[0_18px_36px_rgba(15,23,42,0.18)] hover:bg-slate-800 hover:shadow-[0_22px_42px_rgba(15,23,42,0.22)]"
            >
              Analyze Transcript
            ...
            <button
              ...
              className="button-elevated inline-flex items-center gap-2 rounded-2xl border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-700 hover:border-indigo-200 hover:bg-indigo-50/50 hover:text-slate-900"
            >
        ...
        <section
          id="workspace"
          ref={workspaceRef}
          className="surface-card mt-10 rounded-[36px] border border-white/60 bg-white/90 p-6 shadow-[0_26px_70px_rgba(15,23,42,0.06)]"
        >
          <div className="mb-6 flex flex-wrap items-start justify-between gap-4">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm leading-7 text-slate-500">
                Paste a transcript or upload a plain-text file.
              </p>
            </div>
            ...
            <div className="flex rounded-full border border-slate-200 bg-slate-50 p-1">
              {[
                ...
                <button
                  ...
                  className={cn(
                    "tab-chip rounded-full px-4 py-2 text-sm font-medium",
                    inputMode === mode
...
Each line: Speaker: Text`}
                className="min-h-[320px] w-full rounded-[28px] border border-slate-200 bg-white px-5 py-4 font-mono text-[13px] leading-7 text-slate-700 outline-none transition placeholder:text-slate-400 hover:border-slate-300 focus:border-indigo-400 focus:shadow-[0_0_0_4px_rgba(99,102,241,0.12)]"
              />
            ...
            <div>
              <div
                ...
                className={cn(
                  "surface-card rounded-[28px] border-2 border-dashed p-10 text-center transition",
                  dragOver
              ...
              >
                ...
                />
                <div className="brand-orb mx-auto flex h-16 w-16 items-center justify-center rounded-3xl bg-gradient-to-br from-indigo-600 to-violet-600 text-white shadow-[0_14px_34px_rgba(99,102,241,0.24)]">
              ...
              <div className="mt-4 grid gap-3 md:grid-cols-2">
                <div className="surface-card interactive-card rounded-[24px] border border-slate-200 bg-slate-50/80 p-4">
                  <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-400">
                    Selected file
                  </p>
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-[minmax(0,1fr)_auto_auto] md:items-end">
            ...
            <button
              ...
              className="button-elevated rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm font-semibold text-slate-700 hover:border-indigo-200 hover:bg-indigo-50/50"
            >
              Use Demo Transcript
            </button>
            <button
              ...
              className={cn(
                "button-elevated inline-flex items-center justify-center gap-2 rounded-2xl px-5 py-3 text-sm font-semibold text-white",
                canSubmit && !submitMutation.isPending
                  ? "bg-slate-950 shadow-[0_18px_36px_rgba(15,23,42,0.18)] hover:bg-slate-800 hover:shadow-[0_22px_42px_rgba(15,23,42,0.22)]"
